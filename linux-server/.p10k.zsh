# Generated by Powerlevel10k configuration wizard on 2020-04-24 at 23:14 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    custom_host		    # custom hostname for the server
    dir                     # current directory
    vcs                     # git status
    # prompt_char           # prompt symbol
  )

  # custom hostname for the server: schrammel
  POWERLEVEL9K_CUSTOM_HOST="echo `whoami`@schrammel"
  POWERLEVEL9K_CUSTOM_HOST_FOREGROUND="208"
